        ...
        HStack(alignment: .top, spacing: 24) {
            GeometryReader { geometry in
                Canvas { context, size in
                    ...
                    RayCanvasDrawing.drawAxis(&context, minX: scene.objectX, maxX: scene.screenX, transform: transform)
                    RayCanvasDrawing.drawScreen(&context, x: scene.screenX, halfExtent: halfExtent, transform: transform)
                    ...
                    for (index, objectPoint) in scene.objectSamplePoints.enumerated() {
                        ...
                        RayCanvasDrawing.drawMarker(&context, at: screenPoint, transform: transform, color: .orange)
                    ...
                    RayCanvasDrawing.drawArrowObject(&context, base: projectedBase, tip: projectedTip, transform: transform, color: .orange)
                }
