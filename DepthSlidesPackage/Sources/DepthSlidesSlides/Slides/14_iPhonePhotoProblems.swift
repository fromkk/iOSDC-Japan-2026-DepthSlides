...
struct IPhonePhotoProblems: View {
  ...
  var body: some View {
    SlideWrapper {
      converter.convertPage(
        ...
        - レンズ・センサーサイズ
          - （2026年8月現在）最新の高性能な iPhone でもセンサーサイズは1/1.28インチが最大
          - 少ない光しか取り込むことができない
          - 被写界深度が深い
        - 色作り
  ...
  var script: String = """
    ここまでの話を踏まえて、iPhone で撮影した写真の問題点を見てみます。
    まずレンズとセンサーサイズです。（2026年8月現在）最新の高性能な iPhone でもセンサーサイズは 1/1.28インチが最大で、少ない光しか取り込むことができず、被写界深度が深い、つまりボケにくいという特徴があります。
