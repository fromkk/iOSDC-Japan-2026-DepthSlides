...
^ （フィルターを切り替えながら違いを見せる。注目点: 花びらの縁と背景の境目）

---

## まとめ

（左: Before/After（iPhone のひまわり → Depth Anything V3 + CIGaussianBlur をその場で適用）、右: 結論）

- 今回の選択（暫定）
  - 深度: Depth Anything V3 (da3-small)
  - ボケ: CIGaussianBlur
- 理由: 境界がきれい・61MB・Apache-2.0・速い
- 課題: 髪や細い枝の境界、距離に応じたボケ量の変化

^ まとめです。左が iPhone で撮ったそのままの写真、仕切りを動かすと Depth Anything V3 で深度を推定して CIGaussianBlur でボカした結果です。
