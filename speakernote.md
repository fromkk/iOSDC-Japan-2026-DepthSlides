...
（フェーズ2: 実写の自動切り替え。f1.4〜f16 を往復で自動再生。結論行: 同じ被写体を f値 だけ変えて撮ると、ボケはこう変わる）
...
## PR  9/18(金)・9/19(土) extension DC 2026

- Day1  9/18(金) 19:00〜22:00 / LINEヤフー 赤坂オフィス
  - https://extension-dc.connpass.com/event/391184/
- Day2  9/19(土) 12:30〜19:00 / 六本木ヒルズ某所
  - https://extension-dc.connpass.com/event/391185/

（ロゴの下に Day1 / Day2 のカードを並べ、それぞれ URL から生成した QR を表示）
...
## PR  10/31(土) Kanagawa.swift #3

- 12:00〜21:00 / Hamee 株式会社（小田原）
- 小田原らしいお弁当と懇親会つき
- https://japan-region-swift.connpass.com/event/389036/

（Saitama.swift と同じくバナー + QR の横並び）
